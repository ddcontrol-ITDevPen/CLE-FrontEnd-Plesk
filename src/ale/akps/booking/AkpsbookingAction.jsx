    ...
    const handleStatusUpdate = async () => {
        ...
        try {
            ...
            if (statusModal.nextStatus === "Approved-AKPS") {
                ...
                if (currentContainer.approvedBothTime || currentContainer.approvedCustomTime) {
            ...
            const payload = {
                ...
                ApprovedAKPSTime: statusModal.nextStatus === "Approved-AKPS" ? now : currentContainer.approvedCustomTime,
                ...
                <div className="bg-card-color p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-12 text-sm">
                        <div className="space-y-3">
                            ...
                            <div className="flex justify-between"><span className="text-gray-500">BL/Booking Number</span> <span className="font-bold">{data.aleBooking?.blOrBookingNumber || "N/A"}</span></div>
                            <div className="flex justify-between"><span className="text-gray-500">House BL Number</span> <span className="font-bold">{data.aleBooking?.houseBLNumber || "N/A"}</span></div>
