...
export function ALEEditSubmission() {
            ...
            try {
                ...
                if (booking) {
                    ...
                    setFormData({
                        ...
                        totalPackageQuantity: booking.totalPackageQuantity || 1,
                        weight: booking.weight || 1.0,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const bookingPayload = {
                ...
                houseAWBNumber: formData.houseAWBNumber.to,
