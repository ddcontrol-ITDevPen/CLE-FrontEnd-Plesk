                                ...
                                filteredBookings.map((aleBooking, index) => {
                                    return (
                                        <tr key={aleBooking.rotNumber} className="border-b hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="p-4 whitespace-normal break-words leading-tight font-semibold text-blue-600  cursor-pointer hover:underline" onClick={() => navigate(`/ale/bookingAgent/submission/view/${aleBooking.rotNumber}`)}>{aleBooking.rotNumber}</td>
                                            ...
                                            <td className="p-4 whitespace-nowrap">{aleBooking.eta && aleBooking.eta !== "0001-01-01" ? aleBooking.eta : "N/A"}</td>
