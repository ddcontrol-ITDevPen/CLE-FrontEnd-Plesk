    ...
    useEffect( () => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const bookingAgentId = userData?.companyCode;
                console.log(bookingAgentId);

                if (!bookingAgentId) {
                    console.warn("User has no associated booking agent ID");
                    setIsLoading(false);
                    return;
                }
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                            ...
                            <button
                                onClick={() => navigate("/ale/bookingAgent/rot/add/form")}
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                            <div className="flex justify-between items-center mb-4">
                                ...
                                <button className="text-system-color text-xs font-bold hover:underline" onClick={() => navigate("/ale/bookingAgent/rot/history")}>View All</button>
                            </div>
                                ...
                                {isLoading ? (
                                    ...
                                    recentContainers.map((cont) => (
                                        <div
                                            ...
                                            onClick={() => navigate(`/ale/bookingAgent/rot/view/${cont.containerId}`)}
