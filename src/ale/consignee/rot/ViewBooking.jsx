            ...
            <div className="space-y-6 max-w-7xl mx-auto pb-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2">
                        <InfoSection title="Forwarding Details" icon={Users}>
                            <div className="sm:col-span-2 md:col-span-3">
                                <DataField label="Company Name" value={data.forwarding?.companyName} />
                            </div>
                            <div className="sm:col-span-2 md:col-span-3">
                                <DataField label="Company Address" value={data.forwarding?.address} />
                            </div>
                            <DataField label="SSM/ROC No." value={data?.ssmNumber || "N/A"} />
                            <DataField label="Person In charge (PIC)" value={data.forwarding?.picName || "N/A"} />
                            <DataField label="PIC Contact Handphone" value={data.forwarding?.handphoneNumber} />
                            <DataField label="Email Address" value={data.forwarding?.emailAddress || "N/A"} />
                        </InfoSection>
                    </div>
