...
export function ShippingLineEditBooking2() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const containerPayload = {
                ContainerNumber: containerData.containerNo,
            ...
            setTimeout(() => navigate("/shippingLine/booking/list"), 1500);
        } catch (error) {
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="p-5 rounded-2xl bg-white border border-gray-100 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                            <InputField label="Container No." required value={containerData.containerNo} onChange={(e) => handleInputChange("containerNo", e.target.value)} error={errors.containerNo} />
