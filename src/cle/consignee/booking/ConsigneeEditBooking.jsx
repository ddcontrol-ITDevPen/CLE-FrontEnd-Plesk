...
import {AlertCircle, ArrowLeft, Check, CheckCircle2, Clock, FileText, Save, XCircle, PackageCheck, Truck} from "lucide-react";
...
export function ConsigneeEditBooking() {
    const { id } = useParams();
    ...
    // New function to handle Delivered and RFC status update
            ...
            <div className="space-y-6 max-w-7xl mx-auto pb-10">
                ...
                <div className="max-w-7xl mx-auto px-6 pb-10">
                    <div className="flex justify-end gap-4 pt-4">
                        ...
                        {/* Delivered */}
                        {data.status === "Gate-Out" && data.gatedOutTime !== null && (
                            <button
                                onClick={() => handleDelivered(data.containerId)}
                        ...
                        {/* RFC */}
                        {data.status === "Delivered" && data.deliveredTime !== null && (
                            <button
                                onClick={() => handleRFC(data.containerId)}
                                className="flex items-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-xl font-bold hover:bg-blue-700"
                            >
                                <Truck size={18} />
                                RFC
