...
export function ConsigneeBookingList ()  {
                                        ...
                                        <tr key={cont.containerId} className="border-b hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="p-4 text-left">
                                                ...
                                                <div className="flex items-center justify-start gap-3">
                                                    ...
                                                    {!["RFC","Rejected","Assigned", "Enroute", "Accepted"].includes(cont.status) && (
                                                        <Edit
                                                            size={18}
                                                            className="text-green-600 cursor-pointer hover:text-green-800"
                                                            onClick={() => navigate(`/consignee/booking/edit/${cont.containerId}`)}
                                                        />
                                                    )}
                                                </div>
                                            </td>
