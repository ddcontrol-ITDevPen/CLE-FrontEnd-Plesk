...
import {getAllContainersByConsignee} from "../../../services/containerService.js";
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const consigneeId = userData?.companyCode;

                if (consigneeId) {
                    const containerData = await getAllContainersByConsignee(consigneeId);
