...
import {
    deleteContainer,
    getContainers, updateContainer, getContainerById
...
export function CLECustomsbookingList() {
                                ...
                                paginatedContainers.map((cont, index) => {
                                    ...
                                    return (
                                        <tr key={cont.containerId} className="border-b hover:bg-gray-50 transition-colors">
                                            ...
                                            {/* Custom Form No from booking */}

                                            <td className="p-4 text-center">
                                                {(() => {
                                                    const type = cont.booking?.customFormType;
                                            ...
                                            <td className="p-4 text-center">
                                                <div className="flex flex-col">
                                                    <span className="font-medium">{cont.booking?.awbNumber || "N/A"}</span>
                                                    <span className="text-xs text-gray-500">{cont.booking?.houseAWBNumber}</span>
                                                </div>
                                            </td>

                                            <td className="p-4 text-center text-xs font-bold text-gray-600">{cont.booking?.movementType}</td>
                                            ...
                                            <td className="p-4 text-left">
                                                ...
                                                <div className="flex items-center justify-start gap-3">
                                                    <Eye size={18}
                                                         className="text-gray-600 cursor-pointer hover:text-blue-600" onClick={() => navigate(`/customs/booking/bookingdetails/${cont.containerId}`)}/>
                                                    ...
                                                    {cont.enrouteTime !== null && cont.approvedCustomTime === null && cont.approvedBothTime === null && cont.gatedInTime === null && (
                                                        <button onClick={() => navigate(`/customs/booking/bookingaction/${cont.containerId}`)} className="p-2 bg-green-100 text-green-700 rounded-full hover:bg-green-200 transition-colors" title="Accept / Reject / Examine ">
                                                            <Check size={18} />
                                                        </button>
