...
export function CLECustomsbookingDetails() {
    const { id } = useParams();
    ...
    useEffect(() => {
        const fetchDocuments = async () => {
            ...
            try {
                ...
                const docs = await getBookingDocumentByBookingNumber(data.rotNumber);
                setDocuments(docs || []);
            } catch (error) {
            ...
            <div className="space-y-6 max-w-7xl mx-auto pb-10">
                ...
                <div className="bg-card-color p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-12 text-sm">
                        <div className="space-y-3">
                            ...
                            <div className="flex justify-between"><span className="text-gray-500">AWB Number</span> <span className="font-bold">{data.booking?.awbNumber || "N/A"}</span></div>
                            <div className="flex justify-between"><span className="text-gray-500">House Number</span> <span className="font-bold">{data.booking?.houseAWBNumber || "N/A"}</span></div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Section title="Shipping Information">
                        ...
                        <InfoRow label="Shipping Agent" value={data.booking?.airlineName} />
