...
export function DepotBookingList() {
                    ...
                    <table className="w-full text-left border-collapse lg:table-auto">
                        ...
                        <tr>
                            ...
                            <th className="p-4 border-b w-32">
                                <div className="flex items-center gap-1" onClick={() => handleSort('booking.blOrBookingNumber')}>
                                    BL/Booking Number
                                    {sortConfig.key === 'booking.blOrBookingNumber' && (
                                            ...
                                            <div className="flex items-center justify-start gap-3">
                                                ...
                                                {!["Gate-Out", "Delivered", "RFC","Rejected","Assigned"].includes(cont.status) && (
                                                    <Edit
                                                        ...
                                                        onClick={() => navigate(`/depot/booking/edit/${cont.containerId}`)}
                                                    />
                                                )}
