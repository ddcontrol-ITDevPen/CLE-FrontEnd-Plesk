...
export default function ConsigneeNavBar({ role = "consignee" }) {
    ...
    const menuItems = [
        { icon: LucideHome, label: "Dashboard", path: "/consignee/dashboard" },
        { icon: LucideClipboardClock, label: "Booking List", path: "/consignee/booking/list" },
